        ...
        <div class="row justify-content-center">
            <div class="col-md-8" data-aos="fade-up">
                <div class="profile-image">
                    <img src="assets/img/Nurul.jpeg" alt="Profile Picture">
                </div>
                <h1 class="section-title">Selamat Datang di Website Saya</h1>
                <p class="lead mb-4">Influencer | Designer | UI/UX</p>
                <div class="social-links">
                    <a href="#"><i class="fab fa-facebook-f"></i></a>
                    <a href="https://www.instagram.com/nurull.asyh/"><i class="fab fa-instagram"></i></a>
